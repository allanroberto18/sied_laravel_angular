...
use App\Http\Requests\Admin\PaginaCaracteristicaRequest;
use App\Repositories\PaginaCaracteristicaRepository;

class PaginaCaracteristicaController extends Controller
{
    /**
     * @var PaginaCaracteristicaRepository
     */
    private $repository;
     ...
     */
    public function __construct(PaginaCaracteristicaRepository $repository)
    {
    ...
    public function update(PaginaCaracteristicaRequest $request, $id)
    {
        $entity = $this->repository->find($id);
    ...
    public function create(PaginaCaracteristicaRequest $request)
    {
        $data = $request->all();
