            ...
            <div ng-if="items.data.length > 0">
                <table class="table table-hover">
                    ...
                    <tr dir-paginate="item in items.data | filter: search | itemsPerPage:perPage" total-items="total" current-page="pagination.current">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                    <li role="presentation">
                                        <a role="menuitem" tabindex="-1" href="#" ng-click="load(item)">
                                            <i class="fa fa-pencil-square-o"></i> Editar
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a role="menuitem" tabindex="-1" href="#" ng-click="delete($index, item)">
                        ...
                        <td>@{{ item.id }}</td>
                        <td><i class='fa' ng-class="item.icone"></i> @{{ item.titulo }}</td>
                    </tr>
                    </tbody>
                    <tfooter>
                        <tr>
